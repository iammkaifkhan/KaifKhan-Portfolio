...
export const projects = [
  {
    ...
    description:
      "A full-stack LMS built with React, Redux Toolkit, TailwindCSS, Node.js, and MongoDB. Features include secure authentication, course management, Razorpay payments, Cloudinary media handling, and an admin dashboard with real-time analytics via Chart.js.",
    image: lmsLogo,
    tags: [
      "React",
      "Redux Toolkit",
    ...
    github: "https://github.com/iammkaifkhan/lms-frontend",
    webapp: "https://lmskaif.netlify.app/"
  }
